...
urlpatterns = [
    ...
    path('regions/', RegionAPIListView.as_view(), name='areas-list'),
    path('measurements/', MeasurementsAPIListView.as_view(), name='areas-list'),
    path('measurements/create/', MeasurementsAPICreateView.as_view(), name='areas-list'),
